const COURSE = [
	{
		...
		lessons: [
			{ id: "0.1", title: "Mis on HTML?", src: "chapters/0/0.1.html" },
			{ id: "0.2", title: "HTML-i ajalugu", src: "chapters/0/0.2.html" },
			{ id: "0.3", title: "HTML-i kasutus", src: "" },
			{ id: "0.4", title: "Tekstiredaktori valimine", src: "chapters/0/0.4.html" },
			{ id: "0.5", title: "Esimese HTML-faili loomine", src: "chapters/0/0.5.html" }
		]
	},
	{
		id: "1",
		...
		lessons: [
			{ id: "1.1", title: "HTML dokumendi struktuur", src: "chapters/1/1.1.html" },
			{ id: "1.2", title: "Peamised HTML-sildid", src: "chapters/1/1.2.html" },
			{ id: "1.3", title: "Pealkirjad ja loigud", src: "chapters/1/1.3.html" },
			{ id: "1.4", title: "Lingid", src: "chapters/1/1.4.html" },
			{ id: "1.5", title: "Pildid", src: "chapters/1/1.5.html" },
			{ id: "1.6", title: "Div ja span", src: "chapters/1/1.6.html" },
			{ id: "1.7", title: "Atribuudid", src: "chapters/1/1.7.html" }
		]
	},
	{
		id: "2",
		...
		lessons: [
			{ id: "2.1", title: "Teksti vormindamine", src: "chapters/2/2.1.html" },
			{ id: "2.2", title: "Kommentaarid", src: "chapters/2/2.2.html" },
			{ id: "2.3", title: "Varvid ja taustad", src: "chapters/2/2.3.html" },
			{ id: "2.4", title: "CSS-i kasutamine", src: "chapters/2/2.4.html" },
			{ id: "2.5", title: "Stiilid ja klassid", src: "chapters/2/2.5.html" }
		]
	},
	{
		id: "3",
		...
		lessons: [
			{ id: "3.1", title: "Tabelid", src: "chapters/3/3.1.html" },
			{ id: "3.2", title: "Loendid", src: "chapters/3/3.2.html" },
			{ id: "3.3", title: "Plokid ja inline-elemendid", src: "chapters/3/3.3.html" }
		]
	},
	{
		id: "4",
		...
		lessons: [
			{ id: "4.1", title: "Vormide loomine", src: "chapters/4/4.1.html" },
			{ id: "4.2", title: "Sisendvaljad", src: "chapters/4/4.2.html" },
			{ id: "4.3", title: "Nupud", src: "chapters/4/4.3.html" },
			{ id: "4.4", title: "Vormide valideerimine", src: "chapters/4/4.4.html" }
		]
	},
	{
		id: "5",
		...
		lessons: [
			{ id: "5.1", title: "Pildid", src: "chapters/5/5.1.html" },
			{ id: "5.2", title: "Videod", src: "chapters/5/5.2.html" },
			{ id: "5.3", title: "Audio", src: "chapters/5/5.3.html" }
		]
	},
	{
		id: "6",
		...
		lessons: [
			{ id: "6.1", title: "Iframe", src: "chapters/6/6.1.html" },
			{ id: "6.2", title: "Metaandmed", src: "chapters/6/6.2.html" },
			{ id: "6.3", title: "Semantika", src: "chapters/6/6.3.html" },
			{ id: "6.4", title: "SEO", src: "chapters/6/6.4.html" },
			{ id: "6.5", title: "HTML5 uued voimalused", src: "chapters/6/6.5.html" }
		]
	},
	{
		id: "7",
		...
		lessons: [
			{ id: "7.1", title: "Praktilised ulesanded", src: "chapters/7/7.1.html" },
			{ id: "7.2", title: "KKK", src: "chapters/7/7.2.html" },
			{ id: "7.3", title: "Koik naited", src: "chapters/7/7.3.html" },
			{ id: "7.4", title: "Kokkuvote", src: "chapters/7/7.4.html" },
			{ id: "7.5", title: "Naidisfail allalaadimiseks", src: "chapters/7/7.5.html" }
		]
	}
];
